-- CL / CIL / Quality schedule materializers inserted least(ts + duration, shift_end_at) without
-- verifying end_at > start_at. At hourly/shift boundaries this can equal ts and violate
-- plan24_events_time_order (same pattern fixed earlier for plan24_materialize_check_schedules).
