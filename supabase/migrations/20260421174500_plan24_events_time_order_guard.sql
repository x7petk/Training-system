-- Guard against zero/negative event windows during schedule materialization.
-- This avoids violating plan24_events_time_order when timezone/shift boundaries
-- can collapse event end to start.
