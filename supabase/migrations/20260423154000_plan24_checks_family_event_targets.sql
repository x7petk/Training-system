...
create index if not exists plan24_events_area_id_idx on public.plan24_events (area_id) where deleted_at is null;
create index if not exists plan24_events_equipment_id_idx on public.plan24_events (equipment_id) where deleted_at is null;
