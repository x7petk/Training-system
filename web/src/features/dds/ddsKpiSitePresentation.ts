...
export const DDS_KPI_SITE_PRESENTATION_MODES = ['sum', 'avg', 'max', 'min'] as const
...
export function resolveSiteDdsKpiValue(opts: {
  presentation: DdsKpiSitePresentationMode
  scoring: DdsKpiScoring
