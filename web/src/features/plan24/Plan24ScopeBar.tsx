...
export function Plan24ScopeBar() {
  ...
  return (
    <div className="overflow-x-auto rounded-2xl border border-border-strong bg-surface px-3 py-2 shadow-sm sm:px-4">
      <div className="flex min-w-max flex-wrap items-center gap-2 sm:gap-3">
        ...
        {!cellId ? (
          <span className="text-xs text-amber-700 dark:text-amber-200">Select a cell to use Plan 24.</span>
        ) : null}
      </div>
    </div>
  )
