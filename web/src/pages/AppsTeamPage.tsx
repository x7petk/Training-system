  ...
  return (
    <div className="flex flex-col gap-6 p-4">
      ...
      <div className="flex w-full flex-col gap-6">
        <section id="apps-team-chat" className="w-full">
          <AppsTeamChat
            messages={messages}
            input={input}
            sending={sending}
        ...
        <section id="apps-team-live-board" className="w-full rounded-xl border border-border bg-bg/60 p-3">
        ...
        <section id="apps-team-information" className="w-full rounded-xl border border-border bg-surface">
