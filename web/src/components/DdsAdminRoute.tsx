...
/** Admin or super_admin only (DDS Process in-module Admin link). */
export function DdsAdminRoute({ children }: { children: ReactNode }) {
  ...
  if (!isAdmin) {
    return <Navigate to="/dds-process/plan-24" replace />
  }
